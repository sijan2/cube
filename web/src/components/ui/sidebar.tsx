...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex w-full flex-1 flex-col h-svh min-h-0 overflow-hidden",
        "lg:peer-data-[variant=inset]:m-2 lg:peer-data-[variant=inset]:h-[calc(100svh-1rem)] lg:peer-data-[variant=inset]:rounded-2xl lg:peer-data-[variant=inset]:shadow-sm lg:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className,
      )}
      {...props}
    />
